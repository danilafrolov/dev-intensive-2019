...
//        benderImage = findViewById(R.id.iv_bender)
        ...
        val attempts = savedInstanceState?.getInt("ATTEMPTS") ?: 0
        benderObj = Bender(Bender.Status.valueOf(status), Bender.Question.valueOf(question), attempts)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState?.putInt("ATTEMPTS", benderObj.attempts)
